...
reconstruction uses to prove a run complete; the dashboard records it but does
not gate training on it. `RBTRACE_DISABLE=1` turns the labelling off without
removing the import.
