...
complete, while the dashboard ignores it and groups solely by `x-rb-run`. The labelling
...
| `x-rb-seq` | Added automatically: 1, 2, 3 … within the task. Ignored by the dashboard; used by self-hosted gateway reconstruction, where a gap leaves the run unproven |
