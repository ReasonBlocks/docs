...
| `x-rb-seq` | Added automatically: 1, 2, 3 … within the task. Not read by the dashboard, which groups by `x-rb-run`; the [self-hosted gateway](/gemini-and-bedrock) uses it, where a gap leaves the run unproven |
