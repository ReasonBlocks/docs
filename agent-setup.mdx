...
or Bedrock application is captured through the gateway instead — see
[Gemini and Bedrock](/gemini-and-bedrock) — and a Fireworks or OpenAI Responses
application needs a separately planned compatibility change.
