...
[the setup CLI and skill](/agent-setup). That guide includes release availability
and the source credentials needed before setup.
...
Resolve these paths against your platform API's HTTPS origin and use the exact
URL returned for the source. Treat the capture key as a secret; it expires after
seven days and can be rotated in **Data**.
