...
To prove the cost/accuracy impact on your own tasks, route runs through
[`ab_middleware`](/api-reference/reasonblocks#ab_middleware) and attach the
...
then pull the per-arm report — see [Run an A/B evaluation](/guides/ab-testing).
...
- [Run an A/B evaluation](/guides/ab-testing) — per-arm cost/accuracy report
