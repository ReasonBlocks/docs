...
<Note>
The setup CLI and helper are published on PyPI as `rbtrace==1.1.1`. This version
adds automatic run labelling when the generated helper is imported. If a project
