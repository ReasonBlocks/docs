---
title: "Quickstart"
description: "Point your agent at your ReasonBlocks gateway URL, add the two-line shim, and let ReasonBlocks capture your traces and train a cheaper task-specific model."
---

<Note>
For **Full agent distillation** in the platform dashboard, follow
[Train your complete agent](/full-agent-training). It uses an isolated tool
...
pipeline, and trained model serving. Your integration is one environment variable and two
lines of code — nothing runs on your own servers.

## 1. Get your gateway URL

We issue your tenant gateway URL when you onboard — [reach out](mailto:chetan@reasonblocks.com,sajeev@reasonblocks.com) if you do not have one
yet. It looks like:
